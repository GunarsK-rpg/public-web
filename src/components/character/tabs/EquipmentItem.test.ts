...
import { classifierStore, heroStore } from 'src/__tests__/mockStores';
    ...
    classifierStore({
      equipment: [
        ...
        },
        {
          ...
          isCustom: false,
          attributes: [
            { id: 3, code: 'cumbersome', name: 'Cumbersome', value: 5, isExpert: false },
          ],
          unit: null,
        },
        {
...
vi.mock('src/stores/hero', () => ({
  useHeroStore: () => ({
    ...heroStore({ updateEquipment: mockUpdateEquipment, removeEquipment: mockRemoveEquipment }),
    get saving() {
